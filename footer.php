...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
			...
			<?php 
			$statistics_link = akina_option('site_statistics_link') ? '<a href="'.akina_option('site_statistics_link').'" target="_blank" rel="nofollow">统计</a>' : '';
			$site_map_link = akina_option('site_map_link') ? '<a href="'.akina_option('site_map_link').'" target="_blank" rel="nofollow">网站地图</a>' : '';
			printf(esc_html__( '%1$s &nbsp; %2$s &nbsp; %3$s &nbsp; %4$s', 'akina' ), $site_map_link, '<a href="tencent://message/?uin=2217936322&Site=202g.cn&Menu=yes" rel="designer" target="_blank" rel="nofollow">我叫KK</a>', '<a href="https://202g.cn/" target="_blank" rel="nofollow">无名小站</a>', $statistics_link); 
			?>
			</div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
